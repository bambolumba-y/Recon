...
class ProfileEntries extends Table
  ...
  late final GeneratedColumn<bool> includeInAuto = GeneratedColumn<bool>(
    'include_in_auto',
    aliasedName,
    false,
    type: DriftSqlType.bool,
  ...
  ProfileEntriesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ProfileEntriesData(
      ...
      includeInAuto: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}include_in_auto'],
      )!,
    );
  }
...
class ProfileEntriesData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['include_in_auto'] = Variable<bool>(includeInAuto);
    return map;
  }
  ...
  ProfileEntriesCompanion toCompanion(bool nullToAbsent) {
    return ProfileEntriesCompanion(
      ...
      userOverride: userOverride == null && nullToAbsent
          ? const Value.absent()
          : Value(userOverride),
      includeInAuto: Value(includeInAuto),
    );
  }
  ...
  factory ProfileEntriesData.fromJson(
    ...
    return ProfileEntriesData(
      ...
      includeInAuto: serializer.fromJson<bool>(json['includeInAuto']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'includeInAuto': serializer.toJson<bool>(includeInAuto),
    };
  }
  ...
  ProfileEntriesData copyWith({
    ...
    includeInAuto: includeInAuto ?? this.includeInAuto,
  );
  ProfileEntriesData copyWithCompanion(ProfileEntriesCompanion data) {
    return ProfileEntriesData(
      ...
      userOverride: data.userOverride.present
          ...
          : this.userOverride,
      includeInAuto: data.includeInAuto.present
          ? data.includeInAuto.value
          : this.includeInAuto,
    );
  }
  ...
  String toString() {
    return (StringBuffer('ProfileEntriesData(')
          ...
          ..write('includeInAuto: $includeInAuto')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is ProfileEntriesData &&
          ...
          other.includeInAuto == this.includeInAuto);
}
...
class ProfileEntriesCompanion extends UpdateCompanion<ProfileEntriesData> {
  ...
  final Value<bool> includeInAuto;
  ...
  const ProfileEntriesCompanion({
    ...
    this.includeInAuto = const Value.absent(),
  ...
  static Insertable<ProfileEntriesData> custom({
    ...
    return RawValuesInsertable({
      ...
      if (includeInAuto != null) 'include_in_auto': includeInAuto,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (includeInAuto.present) {
      map['include_in_auto'] = Variable<bool>(includeInAuto.value);
    }
    if (rowid.present) {
